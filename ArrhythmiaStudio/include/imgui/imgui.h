...
#endif
typedef unsigned long long ImGuiID;       // A unique ID used by widgets, typically hashed from a stack of string.
...
enum ImGuiCol_
{
    ...
    ImGuiCol_EditorPrimaryBinCol,
    ImGuiCol_EditorSecondaryBinCol,
    ImGuiCol_COUNT
};
